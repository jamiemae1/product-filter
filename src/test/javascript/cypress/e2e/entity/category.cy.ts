...
describe('Category e2e test', () => {
  ...
  const categorySample = { name: 'or before misspend' };
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="name"]`).type('favorable fumigate');
      cy.get(`[data-cy="name"]`).should('have.value', 'favorable fumigate');

      cy.get(`[data-cy="description"]`).type('nudge ew so');
      cy.get(`[data-cy="description"]`).should('have.value', 'nudge ew so');
